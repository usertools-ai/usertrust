...
When enabled, two directors (Alpha and Beta) review every LLM response using pure heuristic pattern matching. See [Board of Directors](/docs/concepts/board-of-directors).
