...
usertrust uses TigerBeetle for real double-entry accounting -- not a simple counter. Nine transfer codes model the full range of financial operations:
...
| `BUDGET_GRANT` | Budget delegated into a cost-center envelope |
| `BUDGET_RECLAIM` | Cost-center budget returned to its parent |
